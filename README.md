...
## Task 03: Revenue by traffic source by week and month (June 2017)
*   This help to understanding which channels drive the most revenue is critical for optimizing marketing spend and focusing efforts on high-value sources.
*   📄 **SQL Code:**
    ```sql
...
*   This helps understand different browsing behaviors: purchasers might find what they need more efficiently, while non-purchasers might be exploring more broadly or encountering friction. This insight can inform **user experience** improvements.
*   📄 **SQL Code:**
    ```sql
...
*   This metric indicates customer loyalty or repeat purchase frequency, an important aspect of **customer lifetime value**.
*   📄 **SQL Code:**
    ```sql
...
*   This helps quantify the monetary value of a converting session and can inform ROI calculations for marketing efforts.
*   📄 **SQL Code:**
    ```sql
...
*   This is valuable for uncovering **cross-selling** or **bundling** opportunities, which can increase the average order value.
*   📄 **SQL Code:**
    ```sql
...
*   A **Purchase Funnel** (or **Conversion Funnel**) describes the **customer journey** through various stages from initial awareness to final purchase (e.g., View Product → Add to Cart → Complete Purchase). **Cohort Analysis** here involves tracking groups of users (cohorts) as they move through this funnel over time.
*   This helps identify drop-off points (bottlenecks) in the **funnel** and measure the impact of any changes or marketing efforts on **conversion** effectiveness over time.
*   📄 **SQL Code:**
    ```sql
